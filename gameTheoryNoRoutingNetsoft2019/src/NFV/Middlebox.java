...
public class Middlebox implements Serializable{
	...
	public int getTimeGap()
	{
		...
		//if it is the first middlebox return 0
		if (this.id ==0)
		{
			return timeGap;
		}
		...
		/// prevent a null pointer exception if processing time =0 (getIsProcessing will have size 0)
		timeGap = previousMiddlebox.processingTime ==0 ? this.getStartedProcessing(): this.getStartedProcessing()-previousMiddlebox.getIsProcessing()[previousMiddlebox.processingTime-1];
	...
	public boolean equals (Middlebox m)
	{
		if (this.type == m.type && this.id == m.id)
		{
			return true;
		}
