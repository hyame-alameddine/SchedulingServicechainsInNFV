 ...
 * *************************************************************************************************************************/
	 ...
	 * @throws IloException
	 */
    public ILPMinSumCT(int[][]G, int [][]xfk,  int[]tf, int[]N, int []bs, int []ws, int [] us, int[][] psn,int[][]msn, int delta, int maxMiddlebox) throws IloException
    {
    ...
    public ILPMinSumCT(Network network, ArrayList<Service> services, int delta) throws IloException
	{ 	
	...
	public static double[] runModelForResults (Network network, ArrayList<Service> services, String resultsFile ) throws IloException
	{
		...
		ILPMinSumCT model = new ILPMinSumCT(network, services, delta);
	...
	public static void main(String[] args) throws Exception 
	{
		...
		res = ILPMinSumCT.runModelForResults (network, services,"ILPRes.txt");
