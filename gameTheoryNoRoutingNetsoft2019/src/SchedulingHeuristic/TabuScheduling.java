 ...
 * This version does not consider link scheduling and routing. It accounts for transmission delays only as soon as the processing on a vnf is completed
...
public class TabuScheduling {
	...
	public static void main(String[] args)throws Exception {
		...
		// Network  graph = new Network(4,vnfTypesNb,4,5,200,200,1,0);
		 Network  graph =  new Network(7,5,5,5,500,500,1,0);
		...
		//generate services
			...
			ServicesDriver driver =  new ServicesDriver (3,  300, 3,5, 300,500, 5 , 1, 500, 1500,tf);
			...
			//ArrayList<Service> 	servicesObjects = driver.generateServices(20, 10,100,12);
