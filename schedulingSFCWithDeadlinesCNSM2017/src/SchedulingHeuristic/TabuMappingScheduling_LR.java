/**
 * This tabu search is the same as the one done in Design and evaluation of algorithms for mapping and scheduling of virtual network functions however we add link scheduling to it
...
public class TabuMappingScheduling_LR {
	...
	public static void main(String[]args) throws Exception
	{
		...
		ServicesDriver driver = new ServicesDriver (20,  1100, 3, 5, 300, 500, 5 , 1, 500, 1500,tf);
		...
		ArrayList<Service> servicesObjects = driver.generateServices(40, 10,100,12);
		...
		ArrayList<Service>admission =	sh.tabuMappingScheduling(servicesObjects,4, -1);//try 5
	System.out.println (admission.size());
		...
		//System.out.println (servicesObjects.get(11));
