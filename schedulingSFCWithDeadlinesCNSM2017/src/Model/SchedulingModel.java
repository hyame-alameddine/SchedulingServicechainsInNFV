 ...
 * it also accommodates batch scheduling by considering that the network already hosting some services (consider those as parameters and not fixed decision variables) 
 * and need to schedule new services 
 * 
