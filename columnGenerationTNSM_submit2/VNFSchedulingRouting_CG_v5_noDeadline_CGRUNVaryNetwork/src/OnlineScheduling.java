...
public class OnlineScheduling {
	...
	public void reportResults(boolean diversify, int diversificationConf, double executionTime, int adjustementValue, int setId) throws IOException
	{
		 ...
		 FileManipulation resultsFile = new FileManipulation("testResults/varyLinksThread/onlineResults_set"+setId+".txt");
		 FileManipulation batchResultsFile = new FileManipulation("testResults/varyLinksThread/onlineResultsByBatch"+setId+".txt");
	...
	{	
		...
		Driver.serializeServices(services, "testResults/onlineServices_set4.ser");*/
		...
		for (int j=0; j<setNb; j++)
		{
			...
			for (int i=2; i<networkListLinks.size(); i++)//hh
			{
				...
				on.reportResults(diversify, diversificationConf,executionTime, adjustementValue, j);
	...
	public static void main(String[] args) throws IOException, IloException {
		...
		OnlineScheduling.resultsRun(true, true);
