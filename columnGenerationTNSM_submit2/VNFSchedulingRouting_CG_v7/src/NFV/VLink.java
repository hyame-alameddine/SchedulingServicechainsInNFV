...
public class VLink implements Serializable{
	...
	private int startedTransmission;// time slot at which the vlink started transmitting on all the links to which it is mapped - set to 0 if not transmission on this link
	private int[] isTransmitting;//all timeslots at which the vlink is transmitting on all the links to which it is mapped - set to 0 if not transmission on this link
