...
public class DijkstraAlgorithm {
        ...
        private ArrayList<PhysicalMachine> settledNodes;
        private ArrayList<PhysicalMachine> unSettledNodes;
    ...
    public void execute(PhysicalMachine source) {
            settledNodes = new ArrayList<PhysicalMachine>();
            unSettledNodes = new ArrayList<PhysicalMachine>();
    ...
    private PhysicalMachine getMinimum(ArrayList<PhysicalMachine> vertexes) {
