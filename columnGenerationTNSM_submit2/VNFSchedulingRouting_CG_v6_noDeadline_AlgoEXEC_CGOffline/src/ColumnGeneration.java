...
public class ColumnGeneration {
	...
	{	
		...
		int[] tf = physicalNetwork.get(2)[0];	
		 ...
		 //generate services
		ServicesDriver driver = new ServicesDriver (12,  delta, 3, 5, 300, 500, 5 , 1, 500, 1500,tf);//the problem
		...
		CGResults = CG.executeColumnGenerationWithThread(false,masterFilePath, ilpFilePath, pricingFilePath, false);//CG.executeColumnGeneration(false,masterFilePath, ilpFilePath, pricingFilePath, false);
		CGDiverResults = CG.executeColumnGenerationDiversificationWithThread(false, true, 0,3,masterFilePath, ilpFilePath, pricingFilePath);//CG.executeColumnGenerationDiversification(false, true, 0,3,masterFilePath, ilpFilePath, pricingFilePath);
