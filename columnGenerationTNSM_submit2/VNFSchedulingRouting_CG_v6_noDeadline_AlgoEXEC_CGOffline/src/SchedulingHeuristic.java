...
public class SchedulingHeuristic {
	 ...
	 * @param startSchedule the start time slot of the schedule of all services
	 * @param delta timeline
	 * @return schedule length
	 * 
	 * @throws IloException
	 */
	public double scheduleServicesILP (ArrayList<Service> services, int startSchedule, int delta) throws IloException
	{
		String resultsFile = "testResults/schedILPResults.txt";
		
		SchedulingModel schedModel = new SchedulingModel(this.nertwork, services, delta,startSchedule,0); //start scheduling from service 0
		schedModel.buildILPModel();
		 schedModel.runILPModel(resultsFile);

		schedModel.toString();
		
		return schedModel.objectiveValue;
	...
	/**
	 * This function will map and schedule a list of services passed as parameter
	 * It will the total schedule length
	 * 
	 * The Mapping will be at random
	 ...
	 * @throws Exception 
	 */
	public double mapScheduleServiceILPSequentially(ArrayList<Service> services,int startSchedule, int delta) throws Exception
	{	
		...
		scheduleLength = this.scheduleServicesILP(services, startSchedule, delta);
	...
	public static void main(String[] args) throws Exception {
		...
		/*int vnfTypesNb= 4;
		 Network  graph = new Network(4,vnfTypesNb,4,4,200,200,1,0);
		...
		servicesObjects.get(0).setBandwidth(105);
		sh.mapScheduleServiceILPSequentially(servicesObjects, 3, 50);*/
		...
		System.out.println(network);
		 //generate services
		ServicesDriver driver = new ServicesDriver (5,  200, 3, 5, 300, 500, 5 , 1, 500, 1500,tf);
		...
		SchedulingHeuristic sh = new SchedulingHeuristic(network,"logs/ServicesHeuristic.txt");
		sh.mapScheduleServiceILPSequentially(services, 10, 50);
