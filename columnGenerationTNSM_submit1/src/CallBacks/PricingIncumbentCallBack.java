...
public class PricingIncumbentCallBack extends MyIncumbentCallBack{
	
	private CGPricingModel pricingModel;
	private CGMasterModel masterModel;
	public boolean _executed;
	

	
	public PricingIncumbentCallBack(CGPricingModel pricing,CGMasterModel masterModel){
